          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '2', minWidth: '300px' }}>
              ...
              <p style={{ color: 'var(--gray-600)', marginBottom: '20px', lineHeight: 1.7 }}>
                Our PCM Combo Course provides comprehensive coverage of all three subjects with integrated problem-solving strategies. Perfect for JEE aspirants who want to build strong fundamentals in Physics, Chemistry, and Mathematics simultaneously. Expert faculty with proven track records of producing top JEE ranks provide personalized 1-on-1 attention.
              </p>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {[
                  'Integrated Physics, Chemistry & Mathematics curriculum',
                  'Subject experts: IITians for PCM subjects',
                  'Complete NCERT coverage with JEE-level extensions',
                  '15+ years of JEE Previous Year Questions (PYQs)',
                  'Weekly integrated assessment tests',
                  'Cross-subject problem-solving techniques',
                  'Unlimited doubt solving support',
                  'Coordinated study material for all 3 subjects',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '24px' }}>
                {['Mechanics & Waves', 'Electromagnetism', 'Organic Chemistry', 'Physical Chemistry', 'Calculus & Algebra', 'Coordinate Geometry', 'Thermodynamics', 'JEE Mock Tests'].map((topic, i) => (
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {[
                  ...
                  { title: 'Advanced Phase', desc: 'JEE-level problem solving and advanced topic coverage' },
              ...
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                {['Class 11 PCM Students', 'Class 12 PCM Students', 'JEE Main Aspirants', 'JEE Advanced Aspirants', 'Board Exam Prep', 'Dropper Batch'].map((item, i) => (
              ...
              <div style={{ background: 'var(--gray-50)', border: '1px solid var(--gray-200)', borderRadius: 'var(--radius-lg)', padding: '28px', position: 'sticky', top: '100px' }}>
                ...
                <div style={{ marginBottom: '20px', padding: '16px', background: 'var(--white)', borderRadius: 'var(--radius-md)', border: '1px solid var(--gray-200)' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontWeight: 600, color: 'var(--primary)' }}>4.9 ⭐ (150+ reviews)</span>
                  </div>
                </div>
      ...
      <section style={{ padding: '60px 0', background: 'var(--gray-50)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', maxWidth: '900px', margin: '0 auto' }}>
            {[
              { title: 'Physics Specialist', href: '/courses/physics', desc: 'Master Physics for Boards & JEE' },
              { title: 'Chemistry Specialist', desc: 'Organic, Inorganic & Physical Chemistry' },
