...
export const metadata: Metadata = {
  ...
  description: 'Expert Chemistry tuition for Class 11, 12, NEET & JEE. Covers Organic, Inorganic & Physical Chemistry with IITian faculty. NCERT mastery, PYQs & doubt solving.',
};
      ...
      <section style={{
        ...
        <div className="container">
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 800, marginBottom: '16px' }}>
            Excel in Chemistry for Boards & Competitive Exams
          </h1>
          <p style={{ fontSize: '1.1rem', color: 'var(--gray-300)', maxWidth: '680px', margin: '0 auto', lineHeight: 1.6 }}>
            Master Organic, Inorganic & Physical Chemistry with expert faculty. Comprehensive coverage for Class 11, 12, NEET & JEE preparation.
          </p>
        </div>
      </section>
          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '2', minWidth: '300px' }}>
              ...
              <p style={{ color: 'var(--gray-600)', marginBottom: '20px', lineHeight: 1.7 }}>
                Our Chemistry Specialist course provides comprehensive coverage of all three branches - Organic, Inorganic, and Physical Chemistry. Designed by expert IITian and M.Sc faculty, this course ensures conceptual clarity and systematic problem-solving skills essential for Board exams and competitive entrance tests like JEE and NEET.
              </p>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {[
                  'Complete NCERT line-by-line coverage with detailed reactions',
                  'Organic Chemistry: Named reactions, mechanisms & synthesis',
                  'Inorganic Chemistry: Periodic trends, bonding & coordination',
                  'Physical Chemistry: Calculations, thermodynamics & kinetics',
                  '15+ years of Previous Year Questions (PYQs) practice',
                  'Weekly assessment tests and mock examinations',
                  'Unlimited doubt solving through WhatsApp/Call',
                  'Digital notes, reaction charts, and formula sheets',
                  'Flexible schedule: Home Tuition or Online Live Classes',
                ].map((feature, i) => (
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '24px' }}>
                {['Organic Reactions & Mechanisms', 'IUPAC Nomenclature', 'Chemical Bonding', 'Equilibrium & Kinetics', 'Electrochemistry', 'Coordination Chemistry', 'Solid State', 'Surface Chemistry'].map((topic, i) => (
              ...
              <div style={{ background: 'var(--gray-50)', border: '1px solid var(--gray-200)', borderRadius: 'var(--radius-lg)', padding: '28px', position: 'sticky', top: '100px' }}>
                ...
                <div style={{ marginBottom: '20px', padding: '16px', background: 'var(--white)', borderRadius: 'var(--radius-md)', border: '1px solid var(--gray-200)' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontWeight: 600, color: 'var(--primary)' }}>4.9 ⭐ (100+ reviews)</span>
                  </div>
                </div>
