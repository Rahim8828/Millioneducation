          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '2', minWidth: '300px' }}>
              ...
              <p style={{ color: 'var(--gray-600)', marginBottom: '20px', lineHeight: 1.7 }}>
                Our Physics Specialist course is designed for students who want to build strong fundamentals in Physics for both Board exams and competitive entrance tests. Whether you are preparing for JEE Main/Advanced or NEET, our expert IITian faculty provide personalized attention to help you master concepts, solve problems efficiently, and achieve top ranks.
              </p>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {[
                  'Complete NCERT line-by-line coverage with in-depth explanations',
                  '15+ years of Previous Year Questions (PYQs) practice',
                  'Conceptual clarity through interactive 1-on-1 sessions',
                  'Weekly chapter-wise and cumulative assessment tests',
                  'Unlimited doubt solving support via WhatsApp/Call',
                  'Digital PDF notes, formula sheets, and practice problems',
