...
export const metadata: Metadata = {
  title: 'About Us — Dedicated 1-on-1 Personal Coaching Program for 11th, 12th, NEET & JEE',
  description: 'Learn about Million Education, India\'s trusted 1-on-1 personal coaching platform specializing in Class 11 Science, 12th Science, NEET UG, and JEE Main & Advanced.',
};
    ...
    <main>
      ...
      <section className={styles.heroSection}>
        <div className="container">
          ...
          <h1>Transforming Science Education Through 1-on-1 Personal Coaching Program</h1>
        ...
        <div className="container">
          <div className={styles.grid}>
            <div className={styles.card}>
              <div className={styles.iconBox}><Target size={28} color="#2563EB" /></div>
              <h2>Our Mission</h2>
              <p>
            ...
            <div className={styles.card}>
              <div className={styles.iconBox}><Users size={28} color="#2563EB" /></div>
