...
const tutorTestis: Testimonial[] = [
  ...
  { stars: 5, text: '"As a NEET Biology specialist, Million Education gave me direct access to 1-on-1 mentorship leads across Mumbai. Highly professional organization!"', name: 'Rahul Mehta', role: 'NEET Biology Faculty, Mumbai', avatar: 'R' },
