...
const studentTestis: Testimonial[] = [
  { stars: 5, text: '"My son needed intense 1-on-1 Physics & Maths coaching for JEE Main. The mentor provided by Million Education in Andheri was an IITian who transformed his problem-solving speed completely!"', name: 'Priya Sharma', role: 'Parent, Andheri West, Mumbai', avatar: 'P' },
  { stars: 5, text: '"I took the NEET Premium Coaching Program for Class 12 Biology & Chemistry. The regular PYQ practice and mock test reviews were instrumental in securing my NEET rank."', name: 'Rahul Gupta', role: 'NEET Aspirant, Bandra, Mumbai', avatar: 'R' },
...
const tutorTestis: Testimonial[] = [
  { stars: 5, text: '"Mentoring Class 11 & 12 JEE aspirants through Million Education in Mumbai has been deeply rewarding. The platform connects me with serious, dedicated students."', name: 'Dr. Shalini J.', role: 'Senior Physics Mentor, Mumbai', avatar: 'S' },
  { stars: 5, text: '"As a NEET Biology specialist, Million Education gave me direct access to 1-on-1 coaching leads across Mumbai. Highly professional organization!"', name: 'Rahul Mehta', role: 'NEET Biology Faculty, Mumbai', avatar: 'R' },
    ...
    <section className={styles.section} id="testimonials">
      <div className="container">
        ...
        <h2 className={`sectionTitle ${styles.title}`}>
          {variant === 'tutor' ? 'Transforming Education Through 1-on-1 Personal Coaching' : 'Proven Results in 11th, 12th, NEET & JEE'}
        </h2>
        <p className={`sectionSub ${styles.sub}`}>
          Real feedback from {variant === 'tutor' ? 'specialist faculty members' : 'students & parents who achieved top ranks'} with Million Education.
        </p>
