...
const studentSteps: Step[] = [
  ...
  { num: 4, icon: GraduationCap, title: '1-on-1 Mentorship & Success', desc: 'Enjoy weekly tests, PYQ practice, doubt clearing, and continuous performance tracking.' },
];
...
const tutorSteps: Step[] = [
  ...
  { num: 3, icon: Bell, title: 'Receive Mentorship Leads', desc: 'Get matched with serious students looking for 1-on-1 Home or Online coaching.' },
...
export default function HowItWorks({ variant = 'student' }: { variant?: 'student' | 'tutor' }) {
  ...
  const sub = variant === 'tutor'
    ...
    : 'Getting dedicated 1-on-1 mentorship for 11th, 12th, NEET & JEE is quick and hassle-free.';
