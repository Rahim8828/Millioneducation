...
const tutorFaqs: FAQItem[] = [
  ...
  // Earnings & Payments
  { q: 'How much can I earn as a tutor with Million Education?', a: 'Earnings vary based on experience, qualifications, and subject demand: Physics/Maths/IITians: ₹30,000 - ₹50,000/month, Chemistry/M.B.B.S: ₹25,000 - ₹45,000/month, Biology/M.Sc: ₹22,000 - ₹40,000/month. With 15-20 students and 4-5 classes/week, most tutors earn between ₹25K-50K monthly. Top-performing verified IITian tutors can earn up to ₹60,000+.' },
  { q: 'When and how do I receive my payments?', a: 'We follow a transparent and timely payment schedule: (1) Payments are processed on the 5th of every month for the previous month\'s sessions, (2) Direct bank transfer (no cash handling), (3) Detailed session reports available on your dashboard, (4) TDS deductions as per government norms (10% if earnings exceed ₹30,000/month). Payment disputes are resolved within 48 hours.' },
  { q: 'Is there any registration fee or commission?', a: 'Registration on Million Education is 100% FREE with zero membership fees. We deduct a nominal platform fee (15-20%) from each session payment, which covers: Student marketing & lead generation, Platform maintenance & technology, Payment processing, and Customer support. This is our only revenue source - we succeed when you succeed.' },
